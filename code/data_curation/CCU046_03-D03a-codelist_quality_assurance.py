...
# MAGIC %md # CCU046_03-D03a-codelist_quality_assurance
# MAGIC
...
# MAGIC
# MAGIC **Data Output**
# MAGIC - **`ccu007_05_out_codelist_quality_assurance`** : The SNOMED/BNF codes that will be used for quality assurance checks in the later quality assurance notebook. This includes pregnancy/birth/HRT/COCP codes for male sex checks and prostate cancer codes for female sex checks.
...
# HES APC
hes_apc_archive = spark.table(f'{dbc}.hes_apc_all_years_archive')
